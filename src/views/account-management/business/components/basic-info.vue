				...
				<el-row :gutter="50">
					<el-col :span="8">
						...
						<el-form-item label="电话" label-width="130px">
							<el-input v-model="formItem.contacts_mobile" placeholder="请输入手机号或座机号" :readonly="!isEdit" />
						</el-form-item>
						<el-form-item label="法人身份证号" label-width="130px">
							<el-input v-model="formItem.legal_person_idcard" :readonly="!isEdit" />
						</el-form-item>
					</el-col>
					<el-col :span="8">
						...
						<el-form-item label="行业">
							<el-select class="w-full" placeholder="请选择" v-model="formItem.category_id" :readonly="!isEdit">
								<el-option v-for="item in cateGoryOptions" :key="item.id" :label="item.name" :value="item.id"></el-option>
							</el-select>
						</el-form-item>
						<el-form-item label="营业执照有效期">
							<div style="width: 100%">
								<el-date-picker style="width: 100%" :readonly="!isEdit" v-model="formItem.license_end_date" unlink-panels
					...
					<el-col :span="8">
						<el-form-item label="密码">
							...
							<span v-if="isEdit" class="resetPWD" @click="resetPWD">重置密码</span>
						</el-form-item>
						<el-form-item label="联系人">
							<el-input v-model="formItem.contacts" :readonly="!isEdit" />
						</el-form-item>
						<el-form-item label="法人电话">
							<el-input v-model="formItem.legal_person_mobile" placeholder="请输入手机号或座机号" :readonly="!isEdit" />
						</el-form-item>
					</el-col>
				</el-row>
			</div>
				...
				<el-row :gutter="50">
					<el-col :span="8">
						...
						<el-form-item label="纳税人类型" label-width="130px">
							<el-select class="w-full" v-model="formItem.taxpayer_type" :disabled="!isEdit">
						...
						<el-form-item label="计费方式" label-width="130px">
							<el-select class="w-full" v-model="formItem.calculation_type" :disabled="!isEdit">
					...
					<el-col :span="8">
						...
						<el-form-item label="企业地址">
							<el-input v-model="formItem.company_address" :readonly="!isEdit" />
						</el-form-item>
					...
					<el-col :span="8">
						<el-form-item label="企业来源">
							<el-select class="w-full" v-model="formItem.company_source" :disabled="!isEdit">
								<el-option :value="0" label="销售"></el-option>
								<el-option :value="1" label="渠道推广"></el-option>
							</el-select>
						</el-form-item>
						<el-form-item label="接收人号码">
							<el-input v-model="formItem.consignee_mobile" :readonly="!isEdit" placeholder="请输入手机号或座机号" />
						</el-form-item>
						<el-form-item label="企业来源备注">
							<el-input v-model="formItem.company_source_remark" :readonly="!isEdit" placeholder="请输入" />
						</el-form-item>
					</el-col>
				</el-row>
			</div>
