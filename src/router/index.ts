	...
	// 账户管理
	{
		...
		children: [
			...
			// 新建个人渠道
			{
				...
				component: () => import("@/views/account-management/channel/components/add-person.vue"),
			...
			// 新建企业渠道
			{
				...
				component: () => import("@/views/account-management/channel/components/add-business.vue"),
